...
([fdroiddata](https://gitlab.com/fdroid/fdroiddata), `metadata/com.rkd.launcher.yml`). The
...
- `com.rkd.launcher.yml` is that recipe, kept here as a template: `@VERSION_NAME@`,
...
**New application ID.** The recipe uses `com.rkd.launcher` and builds from source. It no longer
