...
import pw.rkd.launcher.ui.home.MusicAppPicker
...
import pw.rkd.launcher.data.CALENDAR_ALL
...
import pw.rkd.launcher.data.HomeAlign
...
import pw.rkd.launcher.ui.home.ClockTapDialog
import pw.rkd.launcher.ui.home.clockTapLabel
import pw.rkd.launcher.ui.home.shortcutLabel
    ...
    Page("Home screen", onBack) {
        ...
        SettingRow(
            ...
            value = when (settings.calendarKey) {
                CALENDAR_ALL -> "All"
                pw.rkd.launcher.data.CALENDAR_SELECTED -> "${settings.calendarKeys.size} selected"
