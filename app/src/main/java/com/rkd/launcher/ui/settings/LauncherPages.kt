...
import com.rkd.launcher.ui.home.MusicAppPicker
...
import com.rkd.launcher.ui.components.SettingRow
import com.rkd.launcher.ui.components.T
import com.rkd.launcher.ui.components.ToggleRow
import com.rkd.launcher.ui.home.ClockTapDialog
import com.rkd.launcher.ui.home.clockTapLabel
import com.rkd.launcher.ui.home.shortcutLabel
    ...
    Page("Home screen", onBack) {
        ...
        SettingRow(
            ...
            value = when (settings.calendarKey) {
                CALENDAR_ALL -> "All"
                com.rkd.launcher.data.CALENDAR_SELECTED -> "${settings.calendarKeys.size} selected"
